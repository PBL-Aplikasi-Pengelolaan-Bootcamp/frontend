...
<body>
    <div class=" m-auto">
        ...
        <nav id="top"
            class="flex z-10 shadow-lg bg-opacity-95 justify-between mx-5 bg-white rounded-full px-3 fixed left-0 top-3 right-0 font-poppins md:rounded-none md:top-0 md:mx-0 md:py-5">
            ...
            <div class="flex gap-3">
                <div class="relative md:hidden">
                    ...
                    <ul id="dropdownMenu" class="absolute left-0 z-10 hidden bg-white shadow-lg rounded-md mt-6">
                        <li><a href="index.html" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Beranda</a>
                        </li>
                        <li><a href="kursus.html" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Kursus</a>
                        </li>
                        <li><a href="about.html#visi"
                ...
                <ul class="gap-4 hidden md:flex font-semibold relative my-auto">
                    ...
                    <li><a href="about.html#visi" class="hover:text-blue-700">Tentang</a></li>
                    <li><a href="#kontak" class="hover:text-blue-700">Kontak</a></li>
                </ul>
            </div>

            <div class=" gap-5 font-semibold my-auto hidden">
                <a href="login.html"
                ...
                <a href="all-access.html"
                    class="md:border hidden md:flex md:border-blue-700 md:rounded-sm bg-blue-700 py-2 px-5 text-white hover">
                    Access</a>
            </div>
            ...
            <div class="w-max">
                <button id="open-modal-btn">
                    <div class=" gap-2 w-max flex">
                        <h1 class="font-semibold relative my-auto hidden sm:flex">Student1</h1>
                        <img src="img/pp-profile.jpg" alt="" class="w-8 h-8 md:w-12 md:h-12 rounded-full">
                    </div>
                </button>
        ...
        <div class="m-auto relative flex flex-col gap-6 mt-24 bg-white p-10 rounded-lg w-11/12">
            ...
            <div class="flex flex-wrap gap-10 m-auto text-center sm:justify-between">
                <a href=""
                    class="flex flex-col m-auto h-max shadow-md rounded-lg w-full md:w-96 overflow-hidden transition-all xl:m-0">
                ...
                <a href=""
                    class="flex flex-col h-max m-auto shadow-md rounded-lg w-full md:w-96 overflow-hidden transition-all xl:m-0">
                ...
                <a href=""
                    ...
                    <img src="img/mysql.jpg" alt="" class="object-center md:h-40">
                    <div class="px-3 py-3 flex flex-col gap-2">
                        <h1 class="font-poppins font-semibold text-sm md:text-base text-left border-slate-600">
                            Fullstack
