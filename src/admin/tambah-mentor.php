...
<body class="bg-gray-100">
    <div class="flex">
        ...
        <aside id="sidebar"
            ...
            <nav>
                <ul>
                    <li class="hover:bg-gray-200"><a href="dashboard-admin.html"
                            class="block p-4 text-gray-700"><ion-icon name="person"
                    ...
                    <li class="hover:bg-gray-200"><a href="#tambah-mentor" class="block p-4 text-gray-700"><ion-icon
                                name="school" class="pr-2 relative top-1 text-xl text-slate-500"></ion-icon>Tambah
                            Mentor</a></li>
            ...
            <div class=" flex flex-col gap-3 mt-5" id="tambah-mentor">
                ...
                <div class="flex flex-col gap-3">
                    <div class="flex gap-2 justify-between p-3 rounded-md bg-white shadow-md">
                        <div class="flex flex-col gap-2">
                            <h1 class="font-semibold text-xl font-poppins">Rafael Setya</h1>
                            <h1>Profesional Front End Developer</h1>
                        </div>
                        ...
                        <div class="flex gap-2 my-auto">
                            ...
                            <button id="openModalIF1"><ion-icon name="information-circle-outline"
                    ...
                    <div class="flex gap-2 justify-between p-3 rounded-md bg-white shadow-md">
                        <div class="flex flex-col gap-2">
                            <h1 class="font-semibold text-xl font-poppins">Ghiyats</h1>
                            <h1>Profesional Backend End Developer</h1>
                        </div>
                        ...
                        <div class="flex gap-2 my-auto">
                            ...
                            <button id="openModalIF2"><ion-icon name="information-circle-outline"
                                    class="bg-sky-700 p-3 text-white rounded-md text-xl"></ion-icon>
                            </button>
                        </div>

                        <!-- Modal Information -->
                        <div id="modalInformation2"
                            class="fixed inset-0 z-20 flex items-center justify-center bg-black bg-opacity-50 hidden">
                            <div
                                class="bg-white rounded-lg overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full">
                                <div class="px-4 py-5 sm:p-6 flex flex-col gap-3">
                                        ...
                                        <div class="flex gap-3 flex-col">
                                            <div class="flex gap-3">
                                                <div class="flex flex-col gap-2">
                                                    <div class="flex flex-col gap-1">
                                                        <h1 class="font-semibold text-lg">Nama</h1>
                                                        <h1 class="text-slate-500">Ghiyats
                                                        </h1>
                                                    </div>
                                                    <div class="flex flex-col gap-1">
                                                        <h1 class="font-semibold text-lg">Expertise</h1>
                                                        <h1 class="text-slate-500">Profesional Backend End Developer
                                                        </h1>
                                                    </div>
                                                </div>
                                                <div class="flex flex-col gap-2">
                                                    ...
                                                    <div class="flex flex-col gap-1">
                                                        <h1 class="font-semibold text-lg">Pengampu</h1>
                                                        <h1 class="text-slate-500">Back End Pemula, Back End Framework.
                                                        </h1>
                                                    </div>
                                                </div>
